def servicio_prediccion(list):
   ...
   # if list[0] == '1' or list[1] == '1' or list[2] == '1' or list[3] == '1' or list[4] == '1' or list[5] == '1' or list[6] == '1':
    #    return 'Posiblemente este comenzando a sufrir Violencia Familiar'
        ...
        return 'Usted no sufre de violencia, pero si tiene alguna duda puede comunicarse con el CHAT-100 del Ministerio de la Mujer y Poblacion Vulnerable https://chat100.aurora.gob.pe/ o el centro de ayuda de su localidad mas cercana'